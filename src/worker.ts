...
// @ts-ignore — OpenNext-generated module, no TypeScript declarations
...
export default {
     ...
     */
    async scheduled(_controller: { scheduledTime: number; cron: string }, env: any, ctx: any): Promise<void> {
